...
public class ImprovedSSLSocketFactory
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ModernHttpClient.ImprovedSSLSocketFactory, ModernHttpClient", ImprovedSSLSocketFactory.class, __md_methods);
	}


	public ImprovedSSLSocketFactory ()
	{
		super ();
		if (getClass () == ImprovedSSLSocketFactory.class)
			mono.android.TypeManager.Activate ("ModernHttpClient.ImprovedSSLSocketFactory, ModernHttpClient", "", this, new java.lang.Object[] {  });
	}

	public ImprovedSSLSocketFactory (javax.net.ssl.SSLSocketFactory p0, javax.net.ssl.TrustManager p1)
	{
		super ();
		if (getClass () == ImprovedSSLSocketFactory.class)
			mono.android.TypeManager.Activate ("ModernHttpClient.ImprovedSSLSocketFactory, ModernHttpClient", "Javax.Net.Ssl.SSLSocketFactory, Mono.Android:Javax.Net.Ssl.ITrustManager, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}
